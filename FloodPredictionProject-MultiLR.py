...
print(data1.head())
#heatmap
#co-relation between the features and target
plt.figure(dpi=125)
...
#model selection- Multi Linear Regression
...
#regression plot between the features and the target of the data
plt.figure(dpi=125)
...
#graphs between the features and target to know the dependence 
...
#mean squared error to the error of the prediction data
